...
spots = Spot.create([
  {
    name: '白鳥岬',
    image: File.open("#{Rails.root}/current/db/fixtures/img/白鳥岬.jpg"),
  ...
  {
    name: 'サバウツガー',
    image: File.open("#{Rails.root}/current/db/fixtures/img/サバウツガー.jpg"),
    description: '行きたい
    行きたい行きたい
    行きたい行きたい行きたい',
    postal_code: '906-0000',
  ...
  {
    name: '与那覇前浜',
    image: File.open("#{Rails.root}/current/db/fixtures/img/与那覇前浜.jpg"),
    description: '行きたい
    行きたい行きたい
    行きたい行きたい行きたい',
    postal_code: '906-0000',
  ...
  {
    name: '17END',
    image: File.open("#{Rails.root}/current/db/fixtures/img/17END.jpg"),
    description: '行きたい
    行きたい行きたい
    行きたい行きたい行きたい',
    postal_code: '906-0000',
  ...
  {
    name: 'シギラ',
    image: File.open("#{Rails.root}/current/db/fixtures/img/シギラ.jpg"),
    description: '行きたい
    行きたい行きたい
    行きたい行きたい行きたい',
    postal_code: '906-0000',
  ...
  {
    name: 'イフ',
    image: File.open("#{Rails.root}/current/db/fixtures/img/イフ.jpg"),
    description: '行きたい
    行きたい行きたい
    行きたい行きたい行きたい',
    postal_code: '906-0000',
  ...
  {
    name: '中の島海岸',
    image: File.open("#{Rails.root}/current/db/fixtures/img/中の島海岸.jpg"),
    description: '行きたい
    行きたい行きたい
    行きたい行きたい行きたい',
    postal_code: '906-0000',
  ...
  {
    name: 'ムスヌン浜',
    image: File.open("#{Rails.root}/current/db/fixtures/img/ムスヌン浜.jpg"),
    description: '行きたい
    行きたい行きたい
    行きたい行きたい行きたい',
    postal_code: '906-0000',
  ...
  {
    name: '名無ビーチ',
    image: File.open("#{Rails.root}/current/db/fixtures/img/名無ビーチ.jpg"),
    description: '行きたい
    行きたい行きたい
    行きたい行きたい行きたい',
    postal_code: '906-0000',
  ...
  {
    name: '長間浜',
    image: File.open("#{Rails.root}/current/db/fixtures/img/長間浜.jpg"),
    description: '行きたい
    行きたい行きたい
    行きたい行きたい行きたい',
    postal_code: '906-0000',
  ...
  {
    name: 'シギラ砂地',
    image: File.open("#{Rails.root}/current/db/fixtures/img/シギラ砂地.jpg"),
    description: '行きたい
    行きたい行きたい
    行きたい行きたい行きたい',
    postal_code: '906-0000',
