...
spot.images.attach(io: File.open("#{Rails.root}/db/fixtures/img/白鳥崎2.jpg"), filename: '白鳥崎2.jpg')
spot = Spot.find(2)
...
spot.images.attach(io: File.open("#{Rails.root}/db/fixtures/img/与那覇前浜2.jpg"), filename: '与那覇前浜2.jpg')
spot = Spot.find(4)
spot.images.attach(io: File.open("#{Rails.root}/db/fixtures/img/17END.jpg"), filename: '17END.jpg')
spot.images.attach(io: File.open("#{Rails.root}/db/fixtures/img/17END2.jpg"), filename: '17END2.jpg')
spot = Spot.find(5)
spot.images.attach(io: File.open("#{Rails.root}/db/fixtures/img/シギラ.jpg"), filename: 'シギラ.jpg')
spot.images.attach(io: File.open("#{Rails.root}/db/fixtures/img/シギラ2.jpg"), filename: 'シギラ2.jpg')
spot = Spot.find(6)
spot.images.attach(io: File.open("#{Rails.root}/db/fixtures/img/イフ.jpg"), filename: 'イフ.jpg')
spot.images.attach(io: File.open("#{Rails.root}/db/fixtures/img/イフ2.jpg"), filename: 'イフ2.jpg')
spot = Spot.find(7)
spot.images.attach(io: File.open("#{Rails.root}/db/fixtures/img/中の島海岸.jpg"), filename: '中の島海岸.jpg')
spot.images.attach(io: File.open("#{Rails.root}/db/fixtures/img/中の島海岸2.jpg"), filename: '中の島海岸2.jpg')
spot = Spot.find(8)
spot.images.attach(io: File.open("#{Rails.root}/db/fixtures/img/ムスヌン浜.jpg"), filename: 'ムスヌン浜.jpg')
spot.images.attach(io: File.open("#{Rails.root}/db/fixtures/img/ムスヌン浜2.jpg"), filename: 'ムスヌン浜2.jpg')
spot = Spot.find(9)
spot.images.attach(io: File.open("#{Rails.root}/db/fixtures/img/名無ビーチ.jpg"), filename: '名無ビーチ.jpg')
spot.images.attach(io: File.open("#{Rails.root}/db/fixtures/img/名無ビーチ2.jpg"), filename: '名無ビーチ2.jpg')
spot = Spot.find(10)
spot.images.attach(io: File.open("#{Rails.root}/db/fixtures/img/長間浜.jpg"), filename: '長間浜.jpg')
spot.images.attach(io: File.open("#{Rails.root}/db/fixtures/img/長間浜2.jpg"), filename: '長間浜2.jpg')
spot = Spot.find(11)
spot.images.attach(io: File.open("#{Rails.root}/db/fixtures/img/ゴルフ場裏.jpg"), filename: 'ゴルフ場裏.jpg')
spot.images.attach(io: File.open("#{Rails.root}/db/fixtures/img/ゴルフ場裏2.jpg"), filename: 'ゴルフ場裏2.jpg')
spot = Spot.find(12)
spot.images.attach(io: File.open("#{Rails.root}/db/fixtures/img/ゼロ.jpg"), filename: 'ゼロ.jpg')
spot.images.attach(io: File.open("#{Rails.root}/db/fixtures/img/ゼロ2.jpg"), filename: 'ゼロ2.jpg')
spot = Spot.find(13)
spot.images.attach(io: File.open("#{Rails.root}/db/fixtures/img/一ノ瀬.jpg"), filename: '一ノ瀬.jpg')
spot.images.attach(io: File.open("#{Rails.root}/db/fixtures/img/一ノ瀬2.jpg"), filename: '一ノ瀬2.jpg')
