...
filenames = ['白鳥崎.jpg', 'サバウツガー.jpg', '与那覇前浜.jpg', '17END.jpg', 'シギラ.jpg', 'イフ.jpg', '中の島海岸.jpg', 'ムスヌン浜.jpg', '名無ビーチ.jpg', '長間浜.jpg', 'ゴルフ場裏.jpg', 'ゼロ.jpg', '一ノ瀬.jpg']
filenames.each.with_index(1) do |fn, i|
  spot = Spot.find(i)
  spot.images.attach(io: File.open("#{Rails.root}/db/fixtures/img/#{fn}"), filename: "#{fn}")
end
